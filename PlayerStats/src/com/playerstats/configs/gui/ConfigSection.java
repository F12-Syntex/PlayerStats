...
import com.playerstats.utils.Communication;
import com.playerstats.utils.ComponentBuilder;
import com.playerstats.utils.Input;
import com.playerstats.utils.MessageUtils;
import com.playerstats.utils.Numbers;
...
public class ConfigSection extends ConfigGUI {
	...
	public List<PagedItem> Contents() {
		...
		this.configSection.getKeys(false).forEach(i -> {
			...
			ItemStack section = new ItemStack(Material.valueOf(PlayerStats.getInstance().configManager.configs.Sections));
			ItemStack ints = new ItemStack(Material.valueOf(PlayerStats.getInstance().configManager.configs.Numbers));
			ItemStack text = new ItemStack(Material.valueOf(PlayerStats.getInstance().configManager.configs.Text));
			ItemStack booleanON = new ItemStack(Material.valueOf(PlayerStats.getInstance().configManager.configs.BooleanON));
			ItemStack booleanOFF = new ItemStack(Material.valueOf(PlayerStats.getInstance().configManager.configs.BooleanOFF));
					...
					execution = () -> {
						...
						Communication.applyInput(player, new Input() {
							...
							public void onRecieve(String o) {
								...
								Bukkit.getScheduler().callSyncMethod(PlayerStats.getInstance(), new Callable<Object>() {
									@Override
